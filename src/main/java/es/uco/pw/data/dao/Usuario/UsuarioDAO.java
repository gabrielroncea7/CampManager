...
public class UsuarioDAO {
     ...
     */
    public boolean escribirUsuario(String nombre, String apellidos, String email, String password, boolean atencionEspecial, boolean esAdmin) {
        ...
        try {
            ...
            preparedStatement.setBoolean(5, atencionEspecial);
            preparedStatement.setBoolean(6, esAdmin);
