		...
		if (userBean != null && userBean.getEmail() != null) {
			if (GestorCampamentos.existeActividad(request.getParameter("nombreActividad"))) {
				if (GestorCampamentos.existeCampamento(Integer.parseInt(request.getParameter("idCampamento")))) {
					if (GestorCampamentos.mismoNivelEducativo(request.getParameter("nombreActividad"),
							Integer.parseInt(request.getParameter("idCampamento")))) {
						if (!GestorCampamentos.existeActividadCampamento(request.getParameter("nombreActividad"),
								Integer.parseInt(request.getParameter("idCampamento")))) {
							if (GestorCampamentos.asociarActividadCampamento(request.getParameter("nombreActividad"),
									Integer.parseInt(request.getParameter("idCampamento")))) {
