/**
 * Este fichero contiene el codigo html que tendra la pagina de administrador para generar el header y el footer.
...
<header class="navbar">
    ...
    <div class="logout-button">
        <a href="/Practica3/mvc/view/adminView.jsp">Volver</a>
    </div>
      <div class="logout-button">
        <a href="/Practica3/mvc/view/ModificarDatosView.jsp">Modificar Datos</a>
    </div>
